...
export const getGeneNames = async () => {
  const res = await fetch(`${SIIBRA_API_ENDPOINT}/v1_0/genes`).then()
...
export const searchRegion = async input => {
  const url = new URL(`${SIIBRA_API_ENDPOINT}/v1_0/atlases/${atlasId}/parcellations/${parcellationId}/regions`)
